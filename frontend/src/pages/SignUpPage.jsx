    ...
    >
      <div className="p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          />
          {formError && (
            <p className="text-red-700 font-semibold mt-2">{formError}</p>
          )}
          {error && <p className="text-red-700 font-semibold mt-2">{error}</p>}
          <PasswordStrengthMeter password={password} />

          <motion.button
            className="mt-5 w-full py-3 px-4 bg-blue-700 text-white font-bold rounded-lg shadow-lg hover:to-blue-900 focus:outline-none focus:ring-2  focus:ring-offset-2 transition duration-200"
